...
SELECT
    ...
    mdst.edema_severity AS `Edema_Severity`,
    mdst.jaundice_severity AS `Jaundice_Severity`,
    mdst.is_heart_with_nad AS `Is_Heart_With_Nad`,
    mdst.is_lungs_with_nad AS `Is_Lungs_With_Nad`,
    mdst.is_lymph_nodes_with_palpable AS `Is_Lymph_Nodes_With_Palpable`,
    mdst.heart_with_nad AS `Heart_With_Nad`,
    mdst.lungs_with_nad AS `Lungs_With_Nad`,
    mdst.lymph_nodes_with_palpable_site AS `Lymph_Nodes_With_Palpable_Site`,
    mdst.lymph_nodes_with_palpable_size AS `Lymph_Nodes_With_Palpable_Size`,
